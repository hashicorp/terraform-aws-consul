...
terraform {
  ...
  # 0.13.0 as the minimum version, as 0.12.26 added support for required_providers with source URLs, and we are also
  # using validation which arrived in 0.13.0 - making it forwards compatible with 0.14.x code.
